...
var tabClickHandler = function (tab, index) {
    this.activate.call(this, index);
};

var tabKeyEventHandler = function (tab, index) {
...
var bindEvents = function () {
    ...
    self.tabs.forEach(function (tab, index) {
        self.tabClickHandlers.push({
            tab,
            tabClickHandler() { tabClickHandler.call(self, tab, index) }
        });
        self.tabKeyEventHandlers.push({
            tab,
            tabKeyEventHandler() { tabKeyEventHandler.call(self, tab, index) }
        });
    });
